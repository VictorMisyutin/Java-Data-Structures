...
public class BookFinder {
    ...
    public List<BookData> searchByISBN(String isbn) {
         ...
         *   stored in the node.
         */
        MyBinarySearchTreeNode<BookLookup> node = isbnToData.find(isbn);
    ...
    public List<BookData> searchByAuthor(String author) {
         ...
         *   stored in the node.
         */
        MyBinarySearchTreeNode<BookLookup> node = authorToData.find(author);
    ...
    public List<BookData> searchByTitle(String title) {
         ...
         *   stored in the node.
         */
        MyBinarySearchTreeNode<BookLookup> node = titleToData.find(title);
    ...
    public List<BookData> searchByPublisher(String publisher) {
         ...
         *   stored in the node.
         */
        MyBinarySearchTreeNode<BookLookup> node = publisherToData.find(publisher);
